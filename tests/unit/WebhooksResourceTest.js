...
describe('WebhooksResouce', () => {
    ...
    describe('verify()', () => {
        ...
        it('should verify the payload', async () => {
            ...
            assert.isFalse(this.cloudConvert.webhooks.verify(payloadString, 'invalid', secret));
            assert.isTrue(this.cloudConvert.webhooks.verify(payloadString, signature, secret));

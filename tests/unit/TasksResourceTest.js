...
describe('TasksResouce', () => {
    ...
    describe('get()', () => {
        ...
        it('should fetch a task by id', async () => {
            ...
            const data = await this.cloudConvert.tasks.get('4c80f1ae-5b3a-43d5-bb58-1a5c4eb4e46b');
    ...
    describe('create()', () => {
        ...
        it('should send the create request', async () => {
            ...
            nock('https://api.cloudconvert.com')
                ...
                .replyWithFile(200, __dirname + '/responses/task_created.json',
                    {'Content-Type': 'application/json'});
    ...
    describe('delete()', () => {
        ...
        it('should send the delete request', async () => {
            ...
            await this.cloudConvert.tasks.delete('2f901289-c9fe-4c89-9c4b-98be526bdfbf');
    ...
    describe('upload()', () => {
        ...
        it('should send the upload request', async () => {
            ...
            nock('https://api.cloudconvert.com')
                ...
                .replyWithFile(200, __dirname + '/responses/upload_task_created.json',
                    {'Content-Type': 'application/json'});
            ...
            nock('https://upload.sandbox.cloudconvert.com', {
                ...
                .post('/storage.de1.cloud.ovh.net/v1/AUTH_b2cffe8f45324c2bba39e8db1aedb58f/cloudconvert-files-sandbox/8aefdb39-34c8-4c7a-9f2e-1751686d615e/?s=jNf7hn3zox1iZfZY6NirNA&e=1559588529')
                .reply(201)
